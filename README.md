# IGNORE ALL of these files/folders besides /contracts, and /test .
...
below is the ancient way to deploy these contracts with truffle, please just git clone repo into remix.ethereum.org instead.
